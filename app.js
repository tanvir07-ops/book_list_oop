...
function Book(title, author, isbn) {
  ...
  // UI Constructor:(er kaaj holo amra jeita screen e dekhte pai jemon delete and add kora ta)
  function UI() {}
